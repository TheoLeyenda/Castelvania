...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("...", "Castelvania-theo", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Castelvania-theo";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Castelvania-theo", null, { width: 256, height: 240 });
